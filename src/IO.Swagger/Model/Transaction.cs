...
namespace IO.Swagger.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        /// <param name="PaymentProduct">PaymentProduct (required).</param>
        ...
        public Transaction(string Id = default(string), TransactionTypeEnum? TransactionType = default(TransactionTypeEnum?), StatusEnum? Status = default(StatusEnum?), string Description = default(string), int? TerminalNumber = default(int?), Card Card = default(Card), int? Number = default(int?), int? AuthorizationCode = default(int?), PaymentProduct PaymentProduct = default(PaymentProduct), string Amount = default(string), DateTime? CreatedAt = default(DateTime?), DateTime? UpdatedAt = default(DateTime?))
        {
            ...
            if (Card == null)
            {
                throw new InvalidDataException("Card is a required property for Transaction and cannot be null");
            }
            else
            {
                this.Card = Card;
            ...
            // to ensure "PaymentProduct" is required (not null)
            if (PaymentProduct == null)
            {
                throw new InvalidDataException("PaymentProduct is a required property for Transaction and cannot be null");
            }
            else
            {
