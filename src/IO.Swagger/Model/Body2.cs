...
namespace IO.Swagger.Model
{
    ...
    public partial class Body2 :  IEquatable<Body2>, IValidatableObject
    {
        ...
        public Body2(string Sku = default(string), string SkuType = default(string), string Name = default(string), string Description = default(string), int? UnitPrice = default(int?), int? Quantity = default(int?), UnitOfMeasureEnum? UnitOfMeasure = default(UnitOfMeasureEnum?), string Details = default(string), DateTime? CreatedAt = default(DateTime?), DateTime? UpdatedAt = default(DateTime?))
        {
            // to ensure "Sku" is required (not null)
            if (Sku == null)
            {
                throw new InvalidDataException("Sku is a required property for Body2 and cannot be null");
            }
            else
            {
                this.Sku = Sku;
            ...
            if (SkuType == null)
            {
                throw new InvalidDataException("SkuType is a required property for Body2 and cannot be null");
            }
            else
            {
            ...
            if (UnitPrice == null)
            {
                throw new InvalidDataException("UnitPrice is a required property for Body2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("UnitOfMeasure is a required property for Body2 and cannot be null");
            }
            else
            {
            ...
            if (CreatedAt == null)
            {
                throw new InvalidDataException("CreatedAt is a required property for Body2 and cannot be null");
            }
            else
            {
            ...
            if (UpdatedAt == null)
            {
                throw new InvalidDataException("UpdatedAt is a required property for Body2 and cannot be null");
            }
            else
            {
