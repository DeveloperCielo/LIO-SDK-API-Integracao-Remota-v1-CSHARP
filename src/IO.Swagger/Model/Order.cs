...
namespace IO.Swagger.Model
{
    ...
    public partial class Order :  IEquatable<Order>, IValidatableObject
    {
        ...
        public Order(string Id = default(string), string Number = default(string), string Reference = default(string), StatusEnum? Status = default(StatusEnum?), DateTime? CreatedAt = default(DateTime?), DateTime? UpdatedAt = default(DateTime?), List<OrderItem> Items = default(List<OrderItem>), string Notes = default(string), List<Transaction> Transactions = default(List<Transaction>), int? Price = default(int?), int? Remaining = default(int?))
        {
